...
def scrape_IMS_weekly():
    ...
    for single_current_data in current_data:
        ...
        if current_item.exists():
            ...
            Weekly.create(forecast_time=current_time, weather_code=str(single_current_data['weather_code']), weather=str(single_current_data['weather']), Temperature=str(single_current_data['temperature']))
